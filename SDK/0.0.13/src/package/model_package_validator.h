...
// Checks package layout and inexpensive configuration invariants only.  The
// Flashlight engine uses this before loading resources once and validating the
// loaded objects in FlashlightDecoderResource.
