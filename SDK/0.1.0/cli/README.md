...
```bash
/home/jinyang_wang/Dev/ASR/ASR_wenet/wenet/SDK/0.1.0/build/asr_package_eval \
  --model_dir /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.1.0/model_flashlight \
  ...
  --output_json /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.1.0/package_eval/output.jsonl

python3 /home/jinyang_wang/Dev/ASR/ASR_wenet/wenet/SDK/0.1.0/cli/summarize_asr_package_eval.py \
  --input_json /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.1.0/package_eval/output.jsonl \
  --summary /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.1.0/package_eval/summary.txt
```
...
--debug true|false    In LM mode, collect final rescoring debug data.
...
```text
lm       Load the package through the SDK and use lexicon first pass plus KenLM final rescore.
...
0.1.0 supports `zipformer2` and `wenet_ctc`. The tool also honors
...
python3 /home/jinyang_wang/Dev/ASR/ASR_wenet/wenet/SDK/0.1.0/cli/summarize_asr_package_eval.py \
  --input_json /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.1.0/package_eval/output.jsonl \
  --summary /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.1.0/package_eval/summary.txt \
  --detail_json /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.1.0/package_eval/detail.jsonl \
  --ref_regex_rules /home/jinyang_wang/Dev/ASR/ASR_wenet/wenet/SDK/0.1.0/cli/ref_text_normalization_rules.tsv
```
