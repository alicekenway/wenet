...
class DynamicContactLexicon {
 public:
  ...
  // Builds only the context-specific contact spellings. The package-sized
  // base trie remains immutable and is traversed alongside this overlay.
  std::shared_ptr<fl::lib::text::Trie> BuildOverlayTrie(
