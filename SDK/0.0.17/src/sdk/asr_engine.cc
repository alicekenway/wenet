  ...
  try {
    ...
    if (!package.has_compact_lexicon) {
      return Status::InvalidArgument(
          "SDK 0.0.17 requires decoder_type="
    ...
    auto backend_template =
        internal::sherpa_onnx_wenet::CreateStreamingCtcBackend(
            ...
            decoder_resource->BlankId(), config.ort_log_level, package.enable_weight_prepacking, package.use_device_allocator_for_initializers);
