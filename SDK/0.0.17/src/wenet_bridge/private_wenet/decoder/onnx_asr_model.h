...
class OnnxAsrModel : public AsrModel {
 ...
 public:
  ...
  void SetMemoryOptions(bool prepacking, bool initializers, int threads) {
    prepacking_ = prepacking; device_initializers_ = initializers; threads_ = threads;
  }
  void Reset() override;
 ...
 private:
  bool prepacking_ = false;
  bool device_initializers_ = false;
  int threads_ = 1;
