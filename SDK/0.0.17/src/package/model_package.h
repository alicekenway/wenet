...
struct ModelPackage {
  ...
  std::filesystem::path lexicon_bin;
  ...
  std::filesystem::path itn_tagger_fst;
  std::filesystem::path itn_verbalizer_fst;
  std::string itn_language;
  bool has_itn = false;
  std::filesystem::path tlg_fst;
  bool has_manifest = false;
  bool has_wfst = false;
  bool has_flashlight_decoder = false;
  bool has_compact_lexicon = false;
  bool debug = false;
  int sample_rate = 16000;
  int chunk_size = 16;
  int num_left_chunks = 16;
  bool enable_weight_prepacking = false;
