...
set(_expected_ort_api "${CMAKE_MATCH_1}")
...
if(NOT _ort_api_line STREQUAL "#define ORT_API_VERSION ${_expected_ort_api}")
  message(FATAL_ERROR "ONNX Runtime headers do not match ${ASR_SDK_REQUIRED_ORT_VERSION}")
endif()
...
# KenLM is built from the source pinned in ASR 0.0.17.
...
target_link_libraries(asr_sdk_ctc_core PUBLIC
  asr_sdk_frontend onnxruntime flashlight-text flashlight-text-kenlm asr_sdk::sentencepiece
...
target_compile_definitions(asr_sdk PRIVATE
  ...
  ASR_SDK_ONNXRUNTIME_VERSION="${ASR_SDK_REQUIRED_ORT_VERSION}"
