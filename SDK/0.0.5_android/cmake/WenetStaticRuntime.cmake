...
if(ASR_SDK_ANDROID_REDUCED_ONNX)
  if(NOT EXISTS "${ASR_SDK_WENET_ONNX_ROOT}/frontend/fbank.h")
    message(FATAL_ERROR
      "WeNet frontend headers not found: ${ASR_SDK_WENET_ONNX_ROOT}/frontend")
  endif()

  set(ASR_SDK_WENET_INCLUDE_DIRS
    "${CMAKE_CURRENT_SOURCE_DIR}/src/android_reduced"
  ...
  message(STATUS "ASR SDK WeNet linkage: Android reduced ONNX frontend only")
  return()
endif()
