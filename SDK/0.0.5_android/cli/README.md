...
```bash
ROOT=/path/to/ASR_wenet

"${ROOT}/wenet/SDK/0.0.5/out_0_0_5/asr_package_eval" \
  --model_dir "${ROOT}/test/0.0.5/model_flashlight" \
  --metadata "${ROOT}/data/hf_wenetspeech_test_net/wenetspeech_test_net_sample_2000/metadata.jsonl" \
  --wav_parent "${ROOT}/data/hf_wenetspeech_test_net/wenetspeech_test_net_sample_2000" \
  --output_json "${ROOT}/test/0.0.5/package_eval/output.jsonl"

python3 "${ROOT}/wenet/SDK/0.0.5/cli/summarize_asr_package_eval.py" \
  --input_json "${ROOT}/test/0.0.5/package_eval/output.jsonl" \
  --summary "${ROOT}/test/0.0.5/package_eval/summary.txt"
```
...
python3 "${ROOT}/wenet/SDK/0.0.5/cli/summarize_asr_package_eval.py" \
  --input_json "${ROOT}/test/0.0.5/package_eval/output.jsonl" \
  --summary "${ROOT}/test/0.0.5/package_eval/summary.txt" \
  --detail_json "${ROOT}/test/0.0.5/package_eval/detail.jsonl" \
  --ref_regex_rules "${ROOT}/wenet/SDK/0.0.5/cli/ref_text_normalization_rules.tsv"
```
