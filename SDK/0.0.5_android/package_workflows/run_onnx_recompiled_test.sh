...
onnx_dir="${1:-${repo_root}/model/wenet_efficient_conformer_aishell_v2_onnx_1}"
out_root="${2:-${sdk_root}/test_runs/onnx_recompiled}"

asr_root="${ASR_ROOT:-${repo_root}}"
tools_dir="${TOOLS_DIR:-${sdk_root}/out-host}"
...
Environment overrides:
  ASR_ROOT, TOOLS_DIR, METADATA, WAV_ROOT, AM_UNITS, TLG_DIR,
...
require_file "${tools_dir}/asr_batch_decode"
...
"${tools_dir}/inspect_package" --model_dir "${no_lm_model}" > "${out_root}/results/inspect_no_lm.txt"
"${tools_dir}/inspect_package" --model_dir "${wfst_model}" > "${out_root}/results/inspect_wfst.txt"
