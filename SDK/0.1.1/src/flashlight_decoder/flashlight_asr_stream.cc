...
wenet::FeaturePipelineConfig MakeFeatureConfig(
    int sample_rate, sherpa_onnx_wenet::ZipformerFeatureType type) {
  switch (type) {
    case sherpa_onnx_wenet::ZipformerFeatureType::kKaldi:
      return wenet::FeaturePipelineConfig(80, sample_rate,
                                          wenet::FeatureType::kKaldi);
    case sherpa_onnx_wenet::ZipformerFeatureType::kNemo: {
      wenet::FeaturePipelineConfig config(80, sample_rate,
                                          wenet::FeatureType::kKaldi);
      config.scale_input_to_unit = true;
      return config;
    }
    case sherpa_onnx_wenet::ZipformerFeatureType::kWhisper:
      return wenet::FeaturePipelineConfig(80, sample_rate,
                                          wenet::FeatureType::kWhisper);
  }
  throw std::runtime_error("unknown CTC feature type");
}
      ...
      : shared(std::move(shared_in)),
        feature_config(std::make_unique<wenet::FeaturePipelineConfig>(
            MakeFeatureConfig(
                ...
                sherpa_onnx_wenet::ParseZipformerFeatureType(
                    shared->feature_type)))),
        feature_pipeline(
