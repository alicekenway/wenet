...
class FlashlightAsrStream final : public AsrStream {
 public:
  ...
  // The base/main decoder always comes from `shared`.  A compiled non-empty
  // contact context supplies only its independently scored contact overlay.
  FlashlightAsrStream(std::shared_ptr<FlashlightAsrResources> shared,
