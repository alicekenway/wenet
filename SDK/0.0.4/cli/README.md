...
```bash
/home/jinyang_wang/Dev/ASR/ASR_wenet/wenet/SDK/0.0.4/build/asr_package_eval \
  --model_dir /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.0.4/model_flashlight \
  ...
  --output_json /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.0.4/package_eval/output.jsonl

python3 /home/jinyang_wang/Dev/ASR/ASR_wenet/wenet/SDK/0.0.4/cli/summarize_asr_package_eval.py \
  --input_json /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.0.4/package_eval/output.jsonl \
  --summary /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.0.4/package_eval/summary.txt
```
...
0.0.4 supports `zipformer2` and `wenet_ctc`. The tool also honors
...
python3 /home/jinyang_wang/Dev/ASR/ASR_wenet/wenet/SDK/0.0.4/cli/summarize_asr_package_eval.py \
  --input_json /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.0.4/package_eval/output.jsonl \
  --summary /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.0.4/package_eval/summary.txt \
  --detail_json /home/jinyang_wang/Dev/ASR/ASR_wenet/test/0.0.4/package_eval/detail.jsonl
```

The optional `--detail_json` output copies each inference row and adds
`metric`, `error_rate`, `unit_count`, `edits`, and the selected metric field.
...
selected metric, and per-utterance error rate.
