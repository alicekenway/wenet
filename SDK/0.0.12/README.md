# WeNet SDK 0.0.12: Multi-stream Thread Safety and Streaming English ITN

SDK 0.0.12 retains the flexible multi-LM decoder and optional inverse text
...
normalization after final output mapping. ITN is applied on every partial and
